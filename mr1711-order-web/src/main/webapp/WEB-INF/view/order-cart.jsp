...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/baobao-logo.png" alt="商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="沙河 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">XXX</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 昌平区 </div>
						<div class="adr-m" limit="30">沙河 xxxxxxxxx</div>
